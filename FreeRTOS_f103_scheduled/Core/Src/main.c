...
osThreadId ReadMPU6050Handle;
osThreadId CalculatePIDHandle;
osThreadId ControllESCHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  osThreadDef(ReadMPU6050, StartReadMPU6050, osPriorityAboveNormal, 0, 128);
  ReadMPU6050Handle = osThreadCreate(osThread(ReadMPU6050), NULL);

  /* definition and creation of CalculatePID */
  osThreadDef(CalculatePID, StartCalculatePID, osPriorityNormal, 0, 128);
  CalculatePIDHandle = osThreadCreate(osThread(CalculatePID), NULL);

  /* definition and creation of ControllESC */
  osThreadDef(ControllESC, StartControllESC, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_StartReadMPU6050 */
/**
...
/* USER CODE BEGIN Header_StartControllESC */
/**
* @brief Function implementing the ControllESC thread.
* @param argument: Not used
* @retval None
*/
...
void StartControllESC(void const * argument)
{
  ...
  /* USER CODE END StartControllESC */
}
